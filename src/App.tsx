...
import { initFirebase, firebaseInitError, firebaseReady } from './firebase';
...
export default function App() {
  ...
  const [fbOk, setFbOk] = useState<boolean>(firebaseReady);
  const [fbErr, setFbErr] = useState<string | null>(firebaseInitError);
