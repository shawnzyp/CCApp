...
- Deploy first, open the app, and paste the Firebase Web App config in the in-app Firebase Setup panel. The config is saved locally on that device.

Option B (dev + build-time):
